...
== Experimental Setup
We generated synthetic telemetry modeled after real-world Sysmon and Suricata events collected from our lab. The dataset comprised 61 time windows of 15 minutes each: 40 benign baseline windows representing normal user and system activity, and 21 malicious windows containing simulated attacks. These attacks spanned seven distinct MITRE ATT&CK techniques, including Defense Evasion (encoded PowerShell execution), Credential Access (credential dumping), and Command and Control (data exfiltration).
